                ...
                <div className="p-6 relative">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="pt-4 flex justify-end gap-3">
                            ...
                            <button type="submit" disabled={loading} className="py-2 px-4 bg-brand-primary text-white font-bold rounded-lg hover:bg-brand-dark disabled:opacity-50">
                                {loading ? 'Guardando...' : (isEditMode ? 'Guardar Cambios' : 'Agregar Mascota')}
                            </button>
                        </div>
                    </form>
                </div>
