...
const AdminUserDetailModal: React.FC<AdminUserDetailModalProps> = ({ user, allPets, allChats, allUsers, onClose, onUpdateStatus, onUpdateRole, onStartChat, onGhostLogin }) => {
