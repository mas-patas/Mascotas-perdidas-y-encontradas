                        ...
                        <div className="relative ml-1 sm:ml-2 flex-shrink-0" ref={accountDropdownRef} data-tour="header-account-btn">
                            ...
                            {isAccountDropdownOpen && (
                                <div className="absolute right-0 mt-2 sm:mt-3 w-[calc(100vw-2rem)] max-w-[240px] sm:w-64 bg-white rounded-xl shadow-2xl py-1 z-30 ring-1 ring-black ring-opacity-5 animate-fade-in border border-gray-100 overflow-hidden">
                                    ...
                                    <button onClick={() => { navigate('/privacidad'); setIsAccountDropdownOpen(false); }} className="w-full text-left px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-700 hover:bg-gray-50 hover:text-brand-primary flex items-center gap-2 sm:gap-3 font-medium"><DocumentIcon className="h-4 w-4 sm:h-5 sm:w-5" /> Privacidad</button>
                                    <button onClick={() => { navigate('/terminos'); setIsAccountDropdownOpen(false); }} className="w-full text-left px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-700 hover:bg-gray-50 hover:text-brand-primary flex items-center gap-2 sm:gap-3 font-medium"><DocumentIcon className="h-4 w-4 sm:h-5 sm:w-5" /> Términos y Condiciones</button>
